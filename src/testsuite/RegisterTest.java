...
public class RegisterTest extends BaseTest {
    ...
    public void userShouldRegisterAccountSuccessfully() {
        ...
        driver.findElement(By.xpath("//select[@name = 'DateOfBirthDay']")).sendKeys("22"); // find element for Date field and enter valid date
        driver.findElement(By.xpath("//select[@name = 'DateOfBirthMonth']")).sendKeys("September"); // find element for Month field and enter valid month
        driver.findElement(By.xpath("//select[@name = 'DateOfBirthYear']")).sendKeys("1992"); // find element for Year field and enter valid year
